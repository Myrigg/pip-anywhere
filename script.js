// script.js
// Runs in the page context when injected by the background script.
// Finds the main video and requests Picture-in-Picture.
...
(() => {
  ...
  try {
    ...
    // Now actually request Picture-in-Picture.
    // This call is happening from script.js injected via chrome.scripting.executeScript,
    // which is the pattern used by the official Google PiP extension.
